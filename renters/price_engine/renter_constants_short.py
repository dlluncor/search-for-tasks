...
property_worth = ['4000', '10000', '18000', '30000', '40000', '60000']
medical_payments = ['1000']
personal_liability = ['100000', '300000']
deductible = ['250', '500', '1000', '1500', '5000']
...
d = OrderedDict([
  ...
  ('State', (['CA'], 'fixed')),
  ('Zip code', (zip_codes, 'fixed')),
  ('Auto insurance coverage?', (['N'], 'iterate')), # Y / N
  # header1
  ('Property Type', (['RENTED HOUSE - SINGLE FAMILY'], 'fixed')),
  ('# units', (['5+'], 'iterate')),
  #('# unrelated roommates', (['0', '1', '2', '3 or more'], 'fixed')),
  ('# unrelated roommates', (['0'], 'fixed')),
  ('roommate names', (('david', 'lee'), 'random')),
  #('# property losses in last 3 years', (['0', '1', '2', '3', '4', '5 or more'], 'fixed')), # '0', '1', '2', '3', '4', '5 or more'
  ('# property losses in last 3 years', (['0'], 'fixed')), # '0', '1', '2', '3', '4', '5 or more'
  ('Phone number', (phone_numbers, 'random')),
  ('Email address', (emails, 'random')),
  # Security systems.
  ('Fire Sprinkler System?', (['Y'], 'iterate')), # Y / N
  ('Central Fire & Burglar Alarm?', (['Y'], 'iterate')), # Y / N
  ('Local Fire / Smoke Alarm?', (['Y'], 'iterate')), # Y / N
  ('Home Security?', (['Y'], 'iterate')), # Y / N
  ('Non Smoking Household?', (['Y'], 'iterate')), # Y / N
  ('Local Burglar Alarm?', (['Y'], 'iterate')), # Y / N
  ...
  ('Farmers Identity Protection', (['N'], 'iterate')), # Y / N
